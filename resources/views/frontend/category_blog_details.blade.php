                ...
                <div class="breadcrumb__wrap__content">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('home.blog')}}">Blogs</a></li>
            ...
            @endforeach
                ...
                <div class="pagination-wrap">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item"><a class="page-link" href="{{route('home.blog')}}"><i class="far fa-long-arrow-left"></i></a></li>
